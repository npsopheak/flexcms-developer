(function(app) {
    app.controller('DashboardPostsCreateCtrl', ['$scope', '$timeout', '$mdSidenav',
        ...
        $scope.$watch('data.category_id', function (category_id){
            ...
            if (tmp && tmp.length){
                ...
                // console.log(tmp, $scope.predefinedCustomFieldByCategory[tmp.name]);
                ...
                if ($scope.predefinedCustomFieldByCategory[tmp.name]){
                    if ($scope.mode === 'create'){
                        ...
                        var gamePlatform = _.filter(categoryCustomFields, function (v){
                            return v.name == 'env-type';
                        });
