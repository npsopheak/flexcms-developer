(function(app) {
    app.controller('DashboardDonorsViewDialogCtrl', ['$scope', '$timeout', '$mdSidenav',
	     ...
	     $scope.data = $current ? angular.copy($current) : null;
            ...
            $scope.save = function ($event) {
                ...
                var success = function () {
                    $current = $scope.data;
                    $rootScope.$emit('dataDirectoryDonorSaved', {
                    ...
                    return $mdDialog.show(
                        $mdDialog.alert({
                            ...
                            autoWrap: true,
                            skipHide: true,
                            title: 'Add Donor info',
                            content: 'Donor info has been saved',
                            ariaLabel: 'Add Donor info',
                            ok: 'Got it!'
                        })
                    )
                        .finally(function () {
                ...
                var fail = function (f) {
                    return $mdDialog.show(
                        $mdDialog.alert({
                            ...
                            title: 'Add Donor info',
                            content: 'There was an error while saving Donor. ' + f,
                            ariaLabel: 'Add Donor info',
                            ok: 'Got it!'
                        })
                    );
                ...
                if ($scope.data.id){
                    ...
                    CoResource.resources.MemberDonor.update({ 
                        id: $scope.data.directory_id, 
                        donorId: $scope.data.id 
                    ...
                    var item = new CoResource.resources.MemberDonor($scope.data);
                    item.$save({
                        id: $scope.data.directory_id
                    }, function (s, h) {
                        success();
