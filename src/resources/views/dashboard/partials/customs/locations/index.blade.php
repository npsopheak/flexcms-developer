        ...
        <md-content layout-padding="16" class="box-shadow-content">
   		...
   		<md-list class="box-shadow-content" style="margin-top: 15px">
        	<table class="directory-listing table-grid">
        		...
        		<tbody>
                    <tr ng-if="!locations.length">
                        <td colspan="3" class="empty-cell">There is no listing yet! Please, add one or more from the left menu</td>
                    </tr>
        			<tr ng-repeat="location in locations | startFrom: (pagination.current - 1) * pagination.limit | limitTo : pagination.limit ">
        				<td class="col-info" style="width: 390px;">
        					<div class="directory-image"
                                style="background-image: url('<% location.cover ? mediaUrl + location.cover.file_name :  location.photo_url %>');  width: 100px; height: 100px;"></div>
        					<div class="directory-basic-info" style="    padding-left: 120px;">
        						<div class="name"><% location.display_name %></div>
        						<div>
        							<span class="tag" ng-repeat="category in location.categories">
        						...
        						<ul class="mini-gallery-list">
        							<li class="gallery-item"
        								...
        								ng-repeat="item in location.photos | limitTo : 4"
        				...
        				<td class="col-info">
        					...
        					<div class="edit-action"  ng-click="view(location)">
