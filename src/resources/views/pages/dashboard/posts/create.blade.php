		...
		<md-content class="box-shadow-content">
			<form layout-padding="16" name="createPostForm">
		      	...
		      	<div layout-gt-xs="column">
			        <md-input-container  flex-gt-xs class="custom-field-value" ng-repeat="field in customFields"
                        style="">
			        	...
			        	<md-icon md-font-icon="icon-office" style="color: gray;"
			        		ng-if="field.not_removable"></md-icon>
		      	...
		      	<div ng-if="mode == 'create'">
			        <div layout-gt-xs="column" ng-repeat="field in categoryCustomFields">
			        	<!-- Specific for game type -->
			        	<div flex-gt-xs ng-if="field.type == 'array-game-type'">
			        		<div class="textarea-group" >
						        <label class="label-container">Game Platforms</label>
						    </div>
			        		<div class="chips-group" flex-gt-xs>
			        	...
			        	<div class="" ng-if="field.type === 'download-link-group'">
					        ...
					        <div class="" ng-repeat="(key, link) in field.model">				        	
						        <md-input-container flex-gt-xs  class="link-input-groups">
						        ...
						        <div class="chips-group" flex-gt-xs style="padding-left: 50px;">
