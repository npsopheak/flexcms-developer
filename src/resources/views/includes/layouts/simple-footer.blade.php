			  	...
			  	<div class="row space0-xs flex-items-xs-top">
			    	<div class="col-md-3 col-sm-12">
			    		<div>
			            	...
			            	<img class="main-logo img-fluid" style="max-height: 55px;" src="{{ asset('img/logo-text.png') }}" alt="Hungry Hungry">
			         	</a>
			    		</div>
			    	...
			    	<div class="col-md-2 col-sm-3">
			    		...
			    		<ul class="menu_list">
			    			...
			    			<li><a href="{{ URL::action('RestaurantController@restaurantType',['category']) }}" title="{{ trans('content.general.categories') }}">{{ trans('content.general.category') }}</a></li>
			    	...
			    	<div class="col-md-2 col-sm-3">
			    		...
			    		<ul class="menu_list">
			    			...
			    			<li><a href="{{ URL::to('/sitemap') }}" title="{{ trans('content.footer.sitemap') }}">{{ trans('content.footer.sitemap') }}</a></li>
			    		</ul>
			    	</div>
			    	<div class="col-md-2 col-sm-3">
