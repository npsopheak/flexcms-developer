...
// Public route group
Route::group(['prefix' => '', 'middleware' => ['csrf'], 'namespace' => 'FlexCMS\BasicCMS\Api'], function()
{
...
// Route::group(['prefix' => 'api/v1', 'namespace' => 'Auth', 'middleware' => ['cors']], function()
// {
...
// // @decepreted in this dashboard version
...
// // @decepreted in this dashboard version
// // Private route group
// Route::group(['prefix' => 'api/v1', 'namespace' => 'Api', 'middleware' => ['auth', 'cors']], function()
// {
